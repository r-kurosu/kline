...
\begin{table}[htbp]
    ...
    $x_i$ &
    \begin{tabular}{l}
    \hspace{1.4em}グループ$i$の左下の$x$座標
    \end{tabular} \\ \hline

    $y_i$ &
    \begin{tabular}{l}
    \hspace{1.4em}グループ$i$の左下の$y$座標
    \end{tabular} \\ \hline
    
    $w_i$ &
    \begin{tabular}{l}
    \hspace{1.4em}グループ$i$の幅
    \end{tabular} \\ \hline

    $h_i$ &
    \begin{tabular}{l}
    \hspace{1.4em}グループ$i$の高さ
    \end{tabular} \\ \hline
    ...
    $w^i_{j}$ &
    \begin{tabular}{l}
    \hspace{1.4em}グループ$i$に詰め込む車$j$の幅
    \end{tabular} \\ \hline

    $h^i_{j}$ &
    \begin{tabular}{l}
    \hspace{1.4em}グループ$i$に詰め込む車$j$の長さ
    \end{tabular} \\ \hline
...
\begin{table}[htbp]
    ...
    $h_i$ &
    \begin{tabular}{l}
    \hspace{1.4em}車$i$の高さ
    \end{tabular} \\ \hline
    
    $W_I$ &
    \begin{tabular}{l}
    \hspace{1.4em}グループ$I$の横幅
    \end{tabular} \\ \hline
    ...
    $\overline{I}$ &
    \begin{tabular}{l}
    \hspace{1.4em}グループ$I$内の既配置の車の集合, $\overline{I} \subseteq I$
    \end{tabular} \\ \hline
...
\subsection{定式化}
まとめると, グループ$I$内の車$i$をパッキングする時の制約は, 次のようになる. 
\begin{center}  
\begin{align}
