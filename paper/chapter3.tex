...
\begin{center}  
\begin{align}
    & \textrm{subject\ to} \hspace{1cm}\\
    &0 \leq x_i \leq W_I - w_i & (i \in I)\\
    &0 \leq y_i \leq H_I - h_i & (i \in I)\\
    &x_i + w_i \leq x_j \hspace{0.3cm}or\hspace{0.3cm} x_j + w_j \leq x_i \hspace{0.3cm}or\hspace{0.3cm} y_i + h_i \leq y_j \hspace{0.3cm}or\hspace{0.3cm} y_j + h_j \leq y_i &(i,j \in I)\\
